...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('1', 'ADMIN'), ('2', 'DOCTOR'), ('3', 'PATIENT'), ('4', 'COMPANY')], max_length=50, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Patient',
            fields=[
                ...
                ('pension_fund', models.CharField(blank=True, max_length=255, null=True)),
                ('medical_insurance', models.CharField(blank=True, max_length=255, null=True)),
